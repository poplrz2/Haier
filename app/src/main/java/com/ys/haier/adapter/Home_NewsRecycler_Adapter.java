...
public class Home_NewsRecycler_Adapter extends RecyclerView.Adapter<Home_NewsRecycler_Adapter.MyViewHolder> {

    private String imgPath = "";
    public List<News.RowsBean> newsList;
    Activity activity;
    ...
    public Home_NewsRecycler_Adapter(Activity activity, List<News.RowsBean> newsList) {
        this.newsList=newsList;
        this.activity = activity;
    }

    public List<News.RowsBean> getNewsList() {
        return newsList;
    }
